...
const values = [
  ...
  },
  {
    icon: Users,
    title: "Fait pour toi",
    desc: "On connaît les défis que vivent les élèves de Côte d'Ivoire. Mibegnon est conçu avec eux, pour eux — en langue qu'ils comprennent.",
    color: "text-[var(--orange)]",
    bg: "bg-[var(--orange)]/10",
  },
  {
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-4 text-slate-600 leading-relaxed">
            ...
            <p>
              ...
              &ldquo;connaissance&rdquo; en langue locale — rassemble toutes ces opportunités
