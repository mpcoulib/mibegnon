  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">{t("subgreeting")}</p>
      </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="font-semibold text-slate-800">{t("card1Title")}</h3>
                  <p className="mt-1 text-sm text-slate-500">{t("card1Desc")}</p>
                </div>
              </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="font-semibold text-slate-800">{t("card2Title")}</h3>
                  <p className="mt-1 text-sm text-slate-500">{t("card2Desc")}</p>
                </div>
              </div>
              <Button asChild size="sm" className="mt-4 w-full border border-[var(--primary)] bg-transparent text-[var(--primary)] hover:bg-[var(--primary)]/10">
                <Link href="/universites" className="flex items-center gap-2">
                  {t("card2Btn")} <ArrowRight size={14} />
                </Link>
              </Button>
            </CardContent>
          </Card>
